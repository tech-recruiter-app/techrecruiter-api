 ...
 * @property-read Collection<int, self<EmployerProfile>> $jobPostings List of user's job postings.
 *
...
final class User extends Authenticatable implements JWTSubject
{
     ...
     *
     * @return HasMany<User<EmployerProfile>, $this>
     */
    public function jobPostings(): HasMany
    {
        /** @var HasMany<User<EmployerProfile>, $this> */
